...
function divide($music)
{
    if ($music % 2 == 0) { // is even
      /*
      Review:
      Een array is geen cijfer, dus $music % 2 is iets wat niet kan. Wat je waarschijnlijk
      ...
      $music er overigens een is - anders gaan doen, rekening houdend met lijn 19?
      */
      floor(count($music) / 2);
      /*
      Review:
      ...
      */
        ...
        Als de array 4 elementen lang is:
          4 / 2 = 2
          2 - 1 = 1
          floor (1) = 1  -> Je komt dus op de helft min 1 uit.
...
//de benamingen $member voor de key, en $value voor de waarde die aan die key is gekoppeld
  ...
  foreach ($_SESSION as $member => $value) {
    ...
    if (is_array($value)) {
      ...
      // en gaan we al meteen de helft daarvan berekenen, afgerond naar beneden wat indien de array-lengte 
